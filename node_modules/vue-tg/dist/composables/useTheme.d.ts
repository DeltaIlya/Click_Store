...
type AllFeatures = v61 & v710;
export type Schema = {
    '6.0': SchemaBase<AllFeatures, v60>;
    '6.1': Merge<Schema['6.0'], v61>;
    '7.10': Merge<Schema['6.1'], v710>;
};
export type Theme = SinceUntil<Schema, '6.0', '6.1'> | SinceUntil<Schema, '6.1', '7.10'> | SinceLatest<Schema, '7.10'>;
...
export declare function useTheme<Version extends BotApiVersion>(baseVersion: Version): import('../types').VersionedReturnType<Theme, Version, keyof Schema>;
export {};
