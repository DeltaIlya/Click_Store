...
type AllFeatures = v77 & v80;
export type Schema = {
    '6.0': SchemaBase<AllFeatures, v60>;
    '7.7': Merge<Schema['6.0'], v77>;
    '8.0': Merge<Schema['7.7'], v80>;
};
export type Viewport = SinceUntil<Schema, '6.0', '7.7'> | SinceUntil<Schema, '7.7', '8.0'> | SinceLatest<Schema, '8.0'>;
...
export declare function useViewport<Version extends BotApiVersion>(baseVersion: Version): import('../types').VersionedReturnType<Viewport, Version, keyof Schema>;
export {};
