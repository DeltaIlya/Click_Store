...
export declare function useWebAppNavigation(): {
    ...
    openInvoice: {
        (url: string): Promise<"cancelled" | "paid" | "failed" | "pending">;
        (url: string, callback?: ((status: "cancelled" | "paid" | "failed" | "pending") => void) | undefined): void;
    };
    /**
     * @deprecated import directly from `vue-tg` instead.
     */
    onInvoiceClosed: typeof onInvoiceClosed;
};
